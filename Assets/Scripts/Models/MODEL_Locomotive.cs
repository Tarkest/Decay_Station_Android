...
public class Locomotive
{
    ...
    public string name;
    public int level;
    public LocomotiveServerData data;
    public LocomotiveUpgradeSlot[] upgradeSlots;
    public LocomotiveBuilding[] buildings;
}

[Serializable]
public class LocomotiveUpgradeSlot
{
    public int id;
    public int count;
...
[Serializable]
public class LocomotiveBuilding
{
    public int id;
    public int index;
